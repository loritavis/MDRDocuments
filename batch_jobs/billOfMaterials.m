...
%billOfMaterials   Simulink Project batch job for generating a "bill of
...
%  When you run the batch job, the Simulink Project provides the file 
%  input for each selected file. 
%
% Output arguments:
%  result - string - Information about the file for inclusion in the 
%  report. The Simulink Project displays this result in the Batch Job
%  Results column.
%
